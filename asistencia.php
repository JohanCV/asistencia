                        ...
                        <table class="table table-sm text-uppercase table-info-asistencia">
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input name="tema" class="form-control" type="text" placeholder="Ingrese el tema..." required> 
                                  </td>
                                </tr>
                                <tr>
  ...
  <script>
    ...
    function showRemaining() {
      ...
      if (distance < 0) {
        ...
        $el.text("Expiró!");
        //location.reload();
        //window.location.replace("mensaje.php");
        //return;
      }
              ...
              data +="{ \"nombre\" : \"" + $(tr).find('td:eq(0)').text()+ "\""; // nombre
                data +=", \"apellidop\" : \"" +$(tr).find('td:eq(1)').text()+ "\""; // apellidop
                  data +=", \"apellidom\" :\""+ $(tr).find('td:eq(2)').text()+"\"";  // apellidom
                    ...
                    data +=", \"observacion\" :\" \"";
                    data +=", \"fk\" :\""+<?php echo $_SESSION["id_cabecera"][0];?>+"\""
                    +"}," // asistencia          
        arrayData.push(
         TableData[row] ={
              "nombre": $(tr).find('td:eq(1)').text(), // nombre
              "cui": $(tr).find('td:eq(2)').text(), // nombre
              ...
              "fk" : <?php echo $_SESSION["id_cabecera"][0];?>,//fk_cabecera    
          }
        );
        }); 
